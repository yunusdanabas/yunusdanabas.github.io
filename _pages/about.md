...
Research experiences at [**PRISMA Lab**](https://prisma.dieti.unina.it/) (University of Naples Federico II), [**Munich Institute of Robotics and Machine Intelligence (TUM MIRMI)**](https://www.mirmi.tum.de/), and [**TÜBİTAK BİLGEM**](https://bilgem.tubitak.gov.tr/) have expanded my expertise in planetary robotics, advanced sensing mechanisms, and multi-robot coordination. Additionally, serving in a leadership role with the [**SURover student robotics team**](https://www.linkedin.com/company/sabancirover/) sharpened my skills in translating simulations into reliable, functional hardware.
